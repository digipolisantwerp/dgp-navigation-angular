...
;angular.module('app').controller('DatepickerPopupDemoCtrl', function ($scope) {
...
(function(){
  ...
  dgpApi.topNavigation = function(element){
    var defaults = {
      menuStr:element
    };
  ...
  dgpApi.sideNavigation = function(element){
    ...
    var setActiveElemnt = function(el){
      ...
      if(el){
        ...
        var lookup = findElUrl(dgpApi.util.getCurrentURL());
...
;angular.module('app').controller('PaginationDemoCtrl', function ($scope, $log) {
  $scope.totalItems = 64;
  $scope.currentPage = 4;
...
;angular.module('app').controller('TimepickerDemoCtrl', function ($scope, $log) {
...
;angular.module('app').controller('TooltipDemoCtrl', function ($scope, $sce) {
...
;angular.module('app').controller('ModalDemoCtrl', function ($uibModal, $log) {
  var $ctrl = this;
